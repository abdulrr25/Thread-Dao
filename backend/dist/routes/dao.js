...
// Create a new DAO
router.post('/', authenticate, validateRequest(createDAOSchema), sanitizeInput, async (req, res) => {
    try {
...
// Join a DAO
router.post('/:address/join', authenticate, validateRequest(joinDAOSchema), sanitizeInput, async (req, res) => {
    try {
        const { address } = req.params;
...
// Manage DAO members
router.post('/:address/members', authenticate, validateRequest(memberManagementSchema), sanitizeInput, async (req, res) => {
    try {
        const { address } = req.params;
...
// Create a proposal
router.post('/:address/proposals', authenticate, validateRequest(createProposalSchema), sanitizeInput, async (req, res) => {
    try {
        const { address } = req.params;
...
// Vote on a proposal
router.post('/:address/proposals/:proposalId/vote', authenticate, validateRequest(voteSchema), sanitizeInput, async (req, res) => {
    try {
