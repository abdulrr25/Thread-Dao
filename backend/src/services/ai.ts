...
interface FounderMatchingOptions {
  interests: string[];
  skills: string[];
  projectType: string;
}

export const getWritingSuggestions = async (options: WritingAssistantOptions) => {
  try {
...
export const semanticSearch = async (options: SemanticSearchOptions) => {
  try {
...
export const findFounderMatches = async (options: FounderMatchingOptions) => {
  try {
